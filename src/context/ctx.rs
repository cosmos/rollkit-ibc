...
/// is `TendermintConsensusState`.
pub trait ConsensusStateConverter:
    TryInto<TendermintConsensusState, Error = ClientError> + From<TendermintConsensusState>
{
}

impl<C> ConsensusStateConverter for C where
    C: TryInto<TendermintConsensusState, Error = ClientError> + From<TendermintConsensusState>
{
}
